...
public class BaiTap02 extends JFrame {
	...
	public BaiTap02() {
		...
		JLabel lblNewLabel = new JLabel("Mau dinh dang Image file");
		...
		JLabel lblUsernameKiemTra = new JLabel("Image file kiem tra");
		...
		btnKiemTra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String tenFile = txtUser.getText();
				String message = tenFile.matches("[\\S]+\\.(?i)(jpg|png|gif|bmp)") ? "hop le" : "khong hop le";
